 ...
 namespace cAlgo
 {
     ...
     public class AccountSample : Indicator
     {
         protected override void Initialize()
         {
             ...
             grid.AddChild(new TextBlock { Text = "TotalMarginCalculationType", Style = style }, 16, 0);
             grid.AddChild(new TextBlock { Text = Account.TotalMarginCalculationType.ToString(), Style = style }, 16, 1);
